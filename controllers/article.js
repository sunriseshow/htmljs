...
(function() {
  var RSS, Sina, authorize, config, func_article, func_bi, func_card, func_column, func_comment, func_count, func_email, func_info, func_payment, func_search, func_user, md5, moment, pagedown, path, read, request, safeConverter, sina;
